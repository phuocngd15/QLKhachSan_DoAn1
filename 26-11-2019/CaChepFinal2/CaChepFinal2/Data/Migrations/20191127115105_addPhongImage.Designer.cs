...
namespace CaChepFinal2.Data.Migrations
{
    ...
    [Migration("20191127115105_addPhongImage")]
    partial class addPhongImage
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CaChepFinal2.Data.DataModel.PhongImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CaChepFinal2.Data.DataModel.PhongImage", b =>
                {
                    b.HasOne("CaChepFinal2.Data.Phong", "phongs")
                        .WithMany("PhongImages")
                        .HasForeignKey("PhongId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
