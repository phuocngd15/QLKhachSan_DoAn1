    ...
    public partial class ver1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_trangThaiDatPhongs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_trangThaiDatPhongs_datPhongs_DatPhongId",
                        column: x => x.DatPhongId,
                        principalTable: "datPhongs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_trangThaiDatPhongs_trangThais_TrangThaiId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_trangThaiDatPhongs_DatPhongId",
                table: "trangThaiDatPhongs",
                column: "DatPhongId");

            migrationBuilder.CreateIndex(
                name: "IX_trangThaiDatPhongs_TrangThaiId",
                table: "trangThaiDatPhongs",
                column: "TrangThaiId");
        }
